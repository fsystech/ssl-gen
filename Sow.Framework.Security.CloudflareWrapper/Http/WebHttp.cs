...
namespace Sow.Framework.Security.CloudflareWrapper.Http {
    ...
    class WebHttp : IWebHttp {
        ...
        public async Task<IWebHttpResponse> DeleteAsync( string requestUri, Dictionary<string, string> header = null ) {
            return await this.AssignHttpClientAsync( requestUri: requestUri, method: "DELETE", header: header );
        }
